...
1. Create a Slackbot and add it to your desired channel by following the instructions listed here: [https://docs.slack.dev/messaging/sending-messages-using-incoming-webhooks/](https://docs.slack.dev/app-management/quickstart-app-settings). Be sure to save the webhook token created after the Slackbot joins your channel.
2. Create a SlackWebhookConnection in your Airflow cluster with your webhook token. You can do this by navigating to the connections tab in your Airflow UI and creating a new connection from there.
