-- Hive 2.3 job with patterns that break on Hive 3.1
-- Uses reserved keywords as column names, SET properties invalid on EMR 7.x

SET hive.execution.engine=mr;

-- Create table (no EXTERNAL — will become ACID on Hive 3)
...
-- Query using unquoted reserved keywords
