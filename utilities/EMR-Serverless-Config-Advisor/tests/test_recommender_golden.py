...
Runs the recommender against extracted event-log fixtures (12 B12 production
jobs + 7 UMP analytics jobs) and diffs the output against a committed golden
...
Design (from INTERNAL_KNOWLEDGE.md "Regression Test Suite" TODO):
  - golden fixtures = extracted metrics JSONs (tests/fixtures/{b12,ump}/)
...
FIXTURES = [os.path.join(HERE, "fixtures", "b12"), os.path.join(HERE, "fixtures", "ump")]
