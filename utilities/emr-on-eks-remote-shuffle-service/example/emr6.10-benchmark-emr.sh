...
aws emr-containers start-job-run \
  ...
  --name em612-emr-jdk17-4xgp3c7gb \
    ...
    "applicationConfiguration": [
      {
        ...
        "properties": {
          "spark.kubernetes.container.image": "'$ECR_URL'/eks-spark-benchmark:emr6.12_jdk17arm",
          "spark.executor.memoryOverhead": "2G",
          "spark.network.timeout": "2000s",
          "spark.executor.heartbeatInterval": "300s",

          "spark.kubernetes.executor.podNamePrefix": "emr-eks-jdk17-4xgp3c7gb",
          "spark.kubernetes.node.selector.eks.amazonaws.com/nodegroup": "4xgp3c7gb",
          "spark.kubernetes.driver.annotation.name":"emr-eks-app-tag-value"
      }},
      {
