...
aws emr-containers start-job-run \
  ...
  --name em66-v0.2-pushReqsInFlight \
    ...
    "applicationConfiguration": [
      {
        ...
        "properties": {
          "spark.kubernetes.container.image": "public.ecr.aws/myang-poc/celeborn-rss:emr6.6_clb0.2",
          "spark.executor.memoryOverhead": "2G",
          "spark.kubernetes.executor.podNamePrefix": "emr-eks-tpcds-main",
