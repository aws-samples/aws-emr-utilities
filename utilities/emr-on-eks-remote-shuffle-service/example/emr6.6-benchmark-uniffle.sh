...
# "spark.rss.writer.buffer.spill.size": "256m",
...
aws emr-containers start-job-run \
  ...
  --name em66-3uniffle-sendthread32-alive200 \
  ...
  "sparkSubmitJobDriver": {
      ...
      "sparkSubmitParameters": "--class com.amazonaws.eks.tpcds.BenchmarkSQL --conf spark.driver.cores=2 --conf spark.driver.memory=3g --conf spark.executor.cores=4 --conf spark.executor.memory=7g --conf spark.executor.instances=47"}}' \
    ...
    "applicationConfiguration": [
      {
        ...
        "properties": {
          ...
          "spark.rss.client.send.thread.num": "32",
