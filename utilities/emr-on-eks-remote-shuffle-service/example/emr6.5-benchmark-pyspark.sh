...
aws emr-containers start-job-run \
  ...
  "sparkSubmitJobDriver": {
      ...
      "sparkSubmitParameters": "--py-files s3://emr-mobileye-us-west-2/benchmarks.zip --conf spark.driver.cores=1 --conf spark.driver.memory=2g --conf spark.executor.cores=4 --conf spark.executor.memory=5g --conf spark.executor.instances=16"}}' \
