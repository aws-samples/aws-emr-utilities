...
Common labels
*/}}
{{- define "shuttle.labels" -}}
helm.sh/chart: {{ include "shuttle.chart" . }}
{{ include "shuttle.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "shuttle.selectorLabels" -}}
app.kubernetes.io/name: {{ include "shuttle.name" . }}
...
*/}}
{{- define "shuttle.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "shuttle.fullname" .) .Values.serviceAccount.name }}
{{- else }}
