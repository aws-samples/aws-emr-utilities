...
> **Note**: This utility is a supplement for [AWS Blog](https://aws.amazon.com/blogs/database/use-amazon-dynamodb-incremental-export-to-update-apache-iceberg-tables/), please follow blog steps for end to end setup.
...
<img src="img/DBBLOG-3584-Figure-1-architecturediagram.png" width="600">
